...
function fig = ir_figure(y, var_list, fig_title, varargin)
...
for j = 1:n
    ...
    hold on
    for k = 1:n_slide
        p = plot([1:t]', y(:,j,k), lstyle{k}, 'linewidth', 2.5);
    ...
    set(s, 'xlim', [1,t]);
    set(s, 'xtick', 1:t, 'xticklabel', 1:t);
    ...
    %Legend
    if n_slide > 0 && ~isempty(varargin{2}) && j==n
        
        
        l=legend(varargin{2}, 'Location', 'East', 'Fontsize', 10);
